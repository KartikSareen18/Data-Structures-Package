...
public class SinglyLinkedList<E> 
{
  ...
  {                 // adds element e to the end of the list
    Node<E> newNode = new Node<>(e, null);    // node will eventually be the tail
    if (isEmpty())
  ...
  public E removeValueAt(int index)
  {
	...
	{
	  Node<E>newNode=new Node<>(e,successor);
	...
	public void addInBetween(E e,int index)
    {
      ...
      else
      {
		...
		addBetween(e,prev_node,curr_node);
      }
    }
	...
	// {
		...
		// Node<E> prev1=null;
		// Node<E> prev2=null;
		// System.out.println(ptr1.getElement()+" "+ptr2.getElement());
